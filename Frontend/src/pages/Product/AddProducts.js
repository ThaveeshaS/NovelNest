...
export default function AddProducts() {
  ...
  // Handle file input changes (cover page)
        ...
        <div className="card-body p-4">
          ...
          <form onSubmit={handleSubmit}>
            <div className="row">
              <div className="col-md-6 mb-3">
                ...
                <input
                  ...
                  required
                />
                {errors.bookTitle && <div className="text-danger">{errors.bookTitle}</div>}
              </div>
              <div className="col-md-6 mb-3">
            ...
            <div className="row">
              <div className="col-md-12 mb-3">
                ...
                <textarea
                  ...
                  required
                />
                {errors.bookDescription && <div className="text-danger">{errors.bookDescription}</div>}
              </div>
            </div>
            <div className="row">
              <div className="col-md-6 mb-3">
                <label htmlFor="bookQuantity" className="form-label">Book Quantity</label>
                <input
                  type="text"
                  className="form-control"
                  id="bookQuantity"
                  ...
                  required
                />
                {errors.bookQuantity && <div className="text-danger">{errors.bookQuantity}</div>}
              </div>
              <div className="col-md-6 mb-3">
            ...
            <div className="row">
              <div className="col-md-6 mb-3">
                ...
                <input
                  ...
                  required
                />
                {errors.authorName && <div className="text-danger">{errors.authorName}</div>}
              </div>
              <div className="col-md-6 mb-3">
            ...
            <div className="row">
              ...
              <div className="col-md-6 mb-3">
                <label htmlFor="coverPage" className="form-label">Cover Page</label>
                <input
                  type="file"
                  className="form-control"
                  id="coverPage"
                  ...
                  required
                />
                {errors.coverPage && <div className="text-danger">{errors.coverPage}</div>}
              </div>
            </div>
